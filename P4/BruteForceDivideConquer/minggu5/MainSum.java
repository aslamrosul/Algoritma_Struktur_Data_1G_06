...
public class MainSum {
  public static void main(String[] args) {
    ...
    for (int i = 0; i < sm.length; i++) {
      ...
      System.out.println(
          "Total kentungan perusahaan selama " + sm[i].elemen + " bulan adalah = " + sm[i].totalBF(sm[i].keuntungan));
      System.out.println("=========================================================================");
      System.out.println("Algoritma Divide Conquer");
      System.out.println("Total keuntungan prubahan selama " + sm[i].elemen + " bulan adalah "
          + sm[i].totalDC(sm[i].keuntungan, 0, sm[i].elemen - 1));

    }
    double totalPerusahaan = 0;
    System.out.println();

    for (int i = 0; i < sm.length; i++) {
      totalPerusahaan += sm[i].totalDC(sm[i].keuntungan, 0, sm[i].elemen - 1);
    }

    System.out.println("=======================================================================");
    System.out.println("Total Keuntungan Semua Perusahaan : " + totalPerusahaan);
    System.out.println("=======================================================================");
